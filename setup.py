...
setup(
    name="azul-plugin-suricata",
    description="Executes Suricata/Snort rules against packets in a Packet Capture file.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_suricata"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-suricata = azul_plugin_suricata.main:main",
        ]
    },
